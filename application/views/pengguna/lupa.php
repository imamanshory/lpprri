...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Konfirm Akun</p>

  
    <form action="<?= base_url() ?>autentikasi/Konfirm" method="post">
      ...
      <div class="form-group has-feedback">
       ...
       <div class="row">
        ...
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Konfirm</button>
        </div>
      </div>
    </form>
